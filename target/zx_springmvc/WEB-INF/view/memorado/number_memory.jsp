	...
	<div class="row">
		<div class="col-xs-4 col-sm-4">
			<button type="button" id="start_random_num"
				onclick="start_random_num()" class="btn btn-default">开始随机数字</button>
		</div>
		<div class="col-xs-4 col-sm-4">
			<button type="button" id="start_random_word"
				onclick="start_random_word()" class="btn btn-default">开始随机词汇</button>
		</div>
		<div class="col-xs-4 col-sm-4">
			<button type="button" id="start_random_num_and_word"
				onclick="start_random_num_and_word()" class="btn btn-default">开始随机数字+词汇</button>
		</div>
	</div>
	<script>
		//刷新数字
		...
		function start_random_num_and_word() {
			if (auto_refresh_flag == 'N') {
				auto_refresh_flag = 'Y';
				$('#start_random_num_and_word').text('停止随机数字+词汇');
				//自动更新数字
				interval = setInterval(function() {
				...
				auto_refresh_flag = 'N';
				$('#start_random_num_and_word').text('开始随机数字+词汇');
				clearInterval(interval);
			}
		};
